    ...
    <body>
       ...
       <form method="POST" action="createFilme.php"> 
...
<?php
    ...
    if(!empty($_POST)){
        ...
        if($validacao)
        {
            ...
            $q = $banco->prepare($sql);
            $q->execute(array($titulo, $descricao, $ano_de_lancamento, $idioma_id, $idioma_original_id, $duracao_da_locacao, $preco_da_locacao, $duracao_do_filme, $custo_de_substituicao, $classificacao, $recursos_especiais, $ultima_atualizacao));
            DB::disconnect();
